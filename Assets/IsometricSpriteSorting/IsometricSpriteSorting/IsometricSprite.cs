...
public class IsometricSprite : MonoBehaviour
{
	...
	void Update ()
    {
        spriteRenderer.sortingOrder = (int)((spriteRenderer.gameObject.transform.position.y-0.2) * PrecisionValue); //Will set the sprites sorting layer order based on its Y axis
    }
}
