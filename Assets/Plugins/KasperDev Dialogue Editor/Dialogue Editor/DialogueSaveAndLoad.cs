...
namespace KasperDev.DialogueEditor
{
    public class DialogueSaveAndLoad
    {
        ...
        private DialogueData SaveNodeData(DialogueNode node)
        {
            ...
            //Set ID
            /*for(int i=0;i<node.DialogueData.dialogueData_BaseContainers.Count;i++)
            {
                node.DialogueData.dialogueData_BaseContainers[i].ID.Value = i;
            }*/

            DialogueData_Name tmpNameData = new DialogueData_Name();
            tmpNameData.CharacterName.Value = node.DialogueData.DialogueData_Name.CharacterName.Value;
            dialogueData.DialogueData_Name = tmpNameData;

            DialogueData_Text tmpTextData = new DialogueData_Text();
            tmpTextData.GuidID = node.DialogueData.DialogueData_Text.GuidID;
            tmpTextData.Text = node.DialogueData.DialogueData_Text.Text;
            tmpTextData.AudioClips = node.DialogueData.DialogueData_Text.AudioClips;
            dialogueData.DialogueData_Text = tmpTextData;

            DialogueData_Images tmpImageData = new DialogueData_Images();
            tmpImageData.Sprite_Left.Value = node.DialogueData.DialogueData_Image.Sprite_Left.Value;
            tmpImageData.Sprite_Right.Value = node.DialogueData.DialogueData_Image.Sprite_Right.Value;
            dialogueData.DialogueData_Image = tmpImageData;

           /* foreach(DialogueData_BaseContainer baseContainer in node.DialogueData.dialogueData_BaseContainers)
            {
                //Name
                if(baseContainer is DialogueData_Name)
                {
                    ...
                    dialogueData.DialogueData_Name.Add(tmpData);
                }
                ...
                if(baseContainer is DialogueData_Text)
                {
                    ...
                    dialogueData.DialogueData_Text.Add(tmpData);
                }
                ...
                if(baseContainer is DialogueData_Images)
                {
                    ...
                    dialogueData.DialogueData_Image.Add(tmpData);
                }
            }*/
        ...
        {
            //Start
            foreach (StartData node in dialogueContainerSO.StartDatas)
            {
            ...
            //End Node
            foreach (EndData node in dialogueContainerSO.EndDatas)
            {
            ...
            //Event Node
            foreach (EventData node in dialogueContainerSO.EventDatas)
            {
            ...
            //Branch Node
            foreach (BranchData node in dialogueContainerSO.BranchDatas)
            {
            ...
            //Choice Node
            foreach(ChoiceData node in dialogueContainerSO.ChoiceDatas)
            {
            ...
            //Dialogue Node
            foreach (DialogueData node in dialogueContainerSO.DialogueDatas)
            {
                ...
                //data_BaseContainer.AddRange(node.DialogueData_Image);
                //data_BaseContainer.AddRange(node.DialogueData_Text);
                //data_BaseContainer.AddRange(node.DialogueData_Name);
                ...
                tempNode.CharacterName(node.DialogueData_Name);
                tempNode.ImagePic(node.DialogueData_Image);
                tempNode.TextLine(node.DialogueData_Text);
        ...
        private void ConnectNodes(DialogueContainerSO dialogueContainerSO)
        {
            ...
            {
                List<NodeLinkData> connections = dialogueContainerSO.NodeLinkDatas.Where(edge => edge.BaseNodeGuid == nodes[i].NodeGuid).ToList();
