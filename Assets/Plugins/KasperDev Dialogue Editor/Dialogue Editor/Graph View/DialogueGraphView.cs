...
namespace KasperDev.DialogueEditor
{
    ...
    {
        private string graphViewStyleSheet = "USS/GraphView/GraphViewStyleSheet";  //Name of the graph view style
        ...
        /// <summary>
        /// Make a new Start Node and set it's position.
        /// </summary>
        ...
        /// <summary>
        /// Make a new End Node and set it's position.
        /// </summary>
        /// <param name="position">position of where to place the node</param>
        ...
        /// <summary>
        /// Make a new Dialogue Node and set it's position.
        /// </summary>
        /// <param name="position">position of where to place the node</param>
        ...
        /// <summary>
        /// Make a new Event Node and set it's position
        /// </summary>
        /// <param name="position">postion of where to place the node</param>
        ...
        /// <summary>
        /// Make a new Branch Node and set it's position.
        /// </summary>
